...
jpeg('figures/lm_PC1_resid_bpad_BrainAgeR', width = 4000, height = 4000, units = "px", res = 500)
plot1
dev.off()
```
...
jpeg('figures/lm_PC1_resid_bpad_photon', width = 4000, height = 4000, units = "px", res = 500)
plot2
dev.off()
```
...
# Open JPEG device
jpeg("cog_performance_scores_distribution.jpeg", width = 1200, height = 800, quality = 100)
